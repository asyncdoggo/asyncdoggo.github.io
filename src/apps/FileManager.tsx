...
function FileExplorerGrid({ currentFolder, setCurrentFolder }: any) {
  ...
  return (
    <div className="file-explorer-grid w-full p-2 grid grid-cols-4 gap-4">
...
function openHtmlFile(file: any) {
  startApplication(
    file.name,
    "https://img.icons8.com/ios-glyphs/30/000000/file.png",
    <IframeWindow src={file.link} />,
  );
}
